  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="index.php" class="logo logo-bg">
        ...
        <span class="logo-lg"><b>NECN Placement</b> Portal</span>
      </a>
              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    ...
                    <li class="active"><a href="mailbox.php"><i class="fa fa-envelope"></i> Resources </a></li>
              ...
              <form action="add-mail.php" method="post">
                <div class="box box-primary">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <input class="form-control input-lg" id="description" name="description" placeholder="Job Description">
                    </div>
                  </div>
                  <!-- /.box-body -->
    ...
    <footer class="main-footer" style="margin-left: 0px;">
      <div class="text-center">
        <strong>Copyright &copy; 2023 <a href="scsit@Davv">NECN Placement Portal</a>.</strong> All rights
        reserved.
      </div>
    </footer>
