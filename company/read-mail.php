  ...
  <div class="wrapper">
              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    ...
                    <li><a href="mailbox.php"><i class="fa fa-envelope"></i> Resources</a></li>
                    ...
                    <div class="box box-primary">
                      ...
                      <div class="box-body no-padding">
                        ...
                        <div class="mailbox-read-message">
                          <a href="<?php echo stripcslashes($row['message']); ?>">Resources</a>
                        </div>
                        ...
                        <div class="mailbox-read-message">
                          <form action="reply-mailbox.php" method="post">
                            <div class="form-group">
                              <input type = "text" class="form-control input-lg" id="description" name="description" placeholder="Job Description">
    ...
    <footer class="main-footer" style="margin-left: 0px;">
      <div class="text-center">
        <strong>Copyright &copy; 2023 <a href="NECN">NECN Placement Portal</a>.</strong> All rights
        reserved.
      </div>
    </footer>
