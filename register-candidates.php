          ...
          <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
            ...
            <form method="post" id="registerCandidates" action="adduser.php" enctype="multipart/form-data">
              <div class="col-md-6 latest-job ">
                ...
                <div class="form-group">
                  <input class="form-control input-lg" type="text" id="rollno" name="rollno" placeholder="Roll Number *" required>
                </div>
                <div class="form-group">
                  <label>Date Of Birth</label>
                  <input class="form-control input-lg" type="date" id="dob" min="1960-01-01" max="2023-01-31" name="dob" placeholder="Date Of Birth">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <input class="form-control input-lg" type="text" id="qualification" name="qualification" placeholder="Highest Qualification (B.Tech/MBA/MCA)">
                </div>
                <div class="form-group">
