  ...
  <div class="wrapper">
            ...
            <div class="container">
              <div class="row">
                ...
                <div class="col-md-8 bg-white padding-2">
                  ...
                  <div>
                    <a href="<?php echo stripcslashes($row['description']); ?>">Apply Now</a>
                  </div>
                  <?php
    ...
    <footer class="main-footer" style="margin-left: 0px;">
      <div class="text-center">
        <strong>Copyright &copy; 2023 <a href="https://necn-placement.000webhostapp.com/">Placement Portal</a>.</strong> All rights
        reserved.
      </div>
    </footer>
