...
<head>
  ...
  <title>NECN Placement Portal</title>
  ...
  <div class="wrapper">
            ...
            <div class="col-md-9 bg-white padding-2">
              ...
              <form action="update-profile.php" method="post" enctype="multipart/form-data">
                ...
                ?>
      			...
      			<div class="form-group">
                          <label for="Marks">Roll Number</label>
                          <input type="text" class="form-control input-lg" id="rollno" name="rollno" placeholder="Roll number" value="<?php echo $row['rollno']; ?>">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control input-lg" id="Marks" name="ssc" placeholder="Percentage(e.g:90)" value="<?php echo $row['ssc']; ?>">
                        </div>
                      ...
                      <div class="col-md-6 latest-job ">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control input-lg" id="qualification" name="qualification" placeholder="B.Tech/MCA/MBA" value="<?php echo $row['qualification']; ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control input-lg" id="Marks" name="ug" placeholder="Percentage(e.g:90)" value="<?php echo $row['ug']; ?>">
                        </div>
                        <div class="form-group">
                          <label for="Marks">Inter Marks</label>
                          <input type="text" class="form-control input-lg" id="Marks" name="pg" placeholder="Percentage(e.g:90)" value="<?php echo $row['pg']; ?>">
                        </div>
                        <div class="form-group">
    ...
    <footer class="main-footer" style="margin-left: 0px;">
      <div class="text-center">
        <strong>Copyright &copy; 2023 <a href="learningfromscratch.online">NECN Placement Portal</a>.</strong> All rights
        reserved.
      </div>
    </footer>
