            ...
            <div class="row">
                ...
                <div class="col md-6">
                    ...
                    <div class="form-group mt-2">
                        ...
                        <label for="fbfield"><i class="fa fa-facebook" aria-hidden="true">GitHub</i></label>
                        <input type="text" id="fbField" placeholder=" Enter here" class=" form-control">

                    </div>
                    <div class="form-group mt-2">

                        <label for="instafield"><i class="fa fa-instagram" aria-hidden="true">Competitive Coding</i></label>
