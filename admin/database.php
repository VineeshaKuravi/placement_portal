...
<body class="hold-transition skin-green sidebar-mini">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col md-13">
                            ...
                            $sql1 = "SELECT distinct jobtitle FROM job_post INNER JOIN apply_job_post ON job_post.id_jobpost=apply_job_post.id_jobpost  INNER JOIN users ON users.id_user=apply_job_post.id_user WHERE apply_job_post.id_company=3";
  ...
  height: 50px; position:absolute; background-color:#1f0a0a; color:white">
        <div class="text-center">
            <strong>Copyright &copy; 2023 NECN Placement Portal</strong> All rights
            reserved.
        </div>
    </footer>
